...
export default function Set({extractName}:SetProps) {
    ...
    const sendInformation = async(event:MouseEvent) => {
        extractName(name);
    ...
    return (
        <>
            ...
            <form className='h-full sm:w-1/3 m-auto flex flex-col items-center justify-center gap-3 text-white text-center bg-blue-800 '>
                <div>
                    <label>
